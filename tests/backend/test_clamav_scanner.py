...
from src.backend.clamav_scanner import (
    FileScanner,
    lambda_handler,
    ValidationException,
    AntiVirusError,
...
class TestClamAVScanner(unittest.TestCase):
    ...
    @patch("src.backend.clamav_scanner.ClamdNetworkSocket")
    ...
    @patch('src.backend.clamav_scanner.S3')
    @patch('src.backend.clamav_scanner.FileScanner')

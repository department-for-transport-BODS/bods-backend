...
@patch("common_layer.db.BodsDB._generate_rds_iam_auth_token", return_value="my_password")
...
@patch("common_layer.db.BodsDB._get_connection_details", return_value=ENVIRONMENT_OUTPUT_TEST_VALUES)

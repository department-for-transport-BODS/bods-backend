...
@patch("common_layer.db.bods_db.BodsDB._generate_rds_iam_auth_token", return_value="my_password")
...
@patch("common_layer.db.bods_db.BodsDB._get_connection_details", return_value=ENVIRONMENT_OUTPUT_TEST_VALUES)
@patch("common_layer.db.bods_db.create_engine")
@patch("common_layer.db.bods_db.automap_base")
@patch("common_layer.db.bods_db.sessionmaker")
...
@patch("common_layer.db.bods_db.BodsDB._get_connection_details", return_value=ENVIRONMENT_OUTPUT_TEST_VALUES)
@patch("common_layer.db.bods_db.create_engine", side_effect=OperationalError)
@patch("common_layer.db.bods_db.automap_base")
@patch("common_layer.db.bods_db.sessionmaker")

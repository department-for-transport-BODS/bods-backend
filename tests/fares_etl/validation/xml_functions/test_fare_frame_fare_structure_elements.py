...
from fares_etl.validation.app.xml_functions.fare_frame_fare_structure_elements import (
...
def test_all_fare_structure_element_checks(
    type_of_fare_str_element_ref_attr_present: bool,
    type_of_access_right_assig_ref_attr_present: bool,
    access_fare_structure_absent: bool,
    eligibility_fare_structure_absent: bool,
    travel_condition_fare_structure_absent: bool,
    length_fare_structure_elements_greater_than_two: bool,
    ref_values_combination_correct: bool,
    expected: list[str],
):
    ...
    result = all_fare_structure_element_checks(None, fare_structure_elements)
...
def test_check_fare_structure_element(
    fare_structure_element_present: bool, expected: list[str]
):
    ...
    fare_structure_elements = get_lxml_element("//x:fareStructureElements", xml)
    result = check_fare_structure_element(None, fare_structure_elements)
    assert result == expected
...
def test_check_type_of_fare_structure_element_ref(
    type_of_fare_structure_element_ref_present: bool, expected: list[str]
):
    fare_structure_element = """
        <TypeOfFareStructureElementRef ref="fxc:travel_conditions" version="fxc:v1.0" />
        <GenericParameterAssignment version="1.0" order="1" id="Tariff@AdultSingle@conditions_of_travel">
    ...
    result = check_type_of_fare_structure_element_ref(None, fare_str_elements)
    assert result == expected
...
def test_check_generic_parameters_for_access(
    type_of_fare_structure_element_ref_ref_present: bool,
    ref_value_is_access: bool,
    generic_parameter_assignment_present: bool,
    type_of_access_right_assignment_ref_present: bool,
    expected: list[str],
):
    ...
    fare_structure_elements = get_lxml_element("//x:fareStructureElements", xml)
    result = check_generic_parameters_for_access(None, fare_structure_elements)
    assert result == expected
...
def test_check_validity_grouping_type_for_access(
    type_of_fare_structure_element_ref_ref_present: bool,
    ref_value_is_access: bool,
    validity_parameter_grouping_type_present: bool,
    validity_parameter_assignment_type_present: bool,
    expected: list[str],
):
    ...
    result = check_validity_grouping_type_for_access(None, generic_parameter_frame)
    assert result == expected
...
def test_check_validity_parameter_for_access(
    type_of_fare_structure_element_ref_ref_present: bool,
    ref_value_is_access: bool,
    validity_parameter_present: bool,
    expected: list[str],
):
    ...
    result = check_validity_parameter_for_access(None, generic_parameter_frame)
    assert result == expected
...
def test_check_generic_parameters_for_eligibility(
    type_of_fare_structure_element_ref_ref_present: bool,
    ref_value_is_eligibility: bool,
    generic_parameter_assignment_present: bool,
    limitation_present: bool,
    user_profile_prsent: bool,
    user_profile_children_present: bool,
    expected: list[str],
):
    fare_structure_element = """<FareStructureElement id="Tariff@AdultSingle@access" version="1.0">
        <TypeOfFareStructureElementRef ref="fxc:eligibility" version="fxc:v1.0" />
    ...
    if type_of_fare_structure_element_ref_ref_present:
        ...
        xml = fare_frames.format(fare_structure_element_without_attribute)
    fare_structure_elements = get_lxml_element("//x:fareStructureElements", xml)
    result = check_generic_parameters_for_eligibility(None, fare_structure_elements)
    assert result == expected
...
def test_check_frequency_of_use(
    type_of_fare_structure_element_ref_ref_present: bool,
    ref_value_is_travel_condition: bool,
    frequency_of_use_present: bool,
    frequency_of_use_type_present: bool,
    expected: list[str],
):
    ...
    result = check_frequency_of_use(None, fare_structure_elements)
    assert result == expected

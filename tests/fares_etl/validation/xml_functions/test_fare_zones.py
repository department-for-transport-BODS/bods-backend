...
from fares_etl.validation.app.xml_functions.fare_zones import (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            False,
            ["5", "Element 'FareZone' is missing within 'fareZones'"],
        ),
    ],
)
def test_is_fare_zones_present_in_fare_frame(
    ...
    fare_zones_present: bool,
    fare_zone_present: bool,
    expected: list[str],
):
  ...
  <FareFrame id="epd:UK:FSYO:FareFrame_UK_PI_FARE_NETWORK:9_Outbound:op" version="1.0" dataSourceRef="data_source" responsibilitySetRef="network_data">
    ...
    fare_frames = get_lxml_element("//x:fareZones", xml)
    result = is_fare_zones_present_in_fare_frame(None, fare_frames)
...
def test_is_name_present_in_fare_frame(
  ...
  <FareFrame id="epd:UK:FSYO:FareFrame_UK_PI_FARE_NETWORK:9_Outbound:op" version="1.0" dataSourceRef="data_source" responsibilitySetRef="network_data">
    ...
    fare_frames = get_lxml_element("//x:fareZones", xml)
    result = is_name_present_in_fare_frame(None, fare_frames)
    assert result == expected

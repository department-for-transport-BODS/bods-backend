...
from fares_etl.validation.app.xml_functions.mandatory_type_of_frame_refs import (
...
def test_fare_frame_type_of_frame_ref_present_fare_price(
    fare_frame: bool,
    fare_frame_valid_id: bool,
    type_of_frame_ref: bool,
    ...
    response = check_fare_frame_type_of_frame_ref_present_fare_price(None, frames)
...
def test_fare_frame_type_of_frame_ref_present_fare_product(
    ...
    frames = get_lxml_element(FARE_FRAME_X_PATH, xml)
    response = check_fare_frame_type_of_frame_ref_present_fare_product(None, frames)
    assert response == expected
...
def test_resource_frame_type_of_frame_ref_present(
    ...
    response = check_resource_frame_type_of_frame_ref_present(None, frames)
    assert response == expected

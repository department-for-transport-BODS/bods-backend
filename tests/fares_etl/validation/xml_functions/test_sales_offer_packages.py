...
from fares_etl.validation.app.xml_functions.sales_offer_packages import (
...
def test_check_sales_offer_package(
    ...
    sales_offer_packages_present: bool,
    sales_offer_package_present: bool,
    expected: list[str],
):
  ...
  <FareFrame version="1.0" id="epd:UK:FSYO:FareFrame_UK_PI_FARE_PRODUCT:Line_9_Outbound:op" dataSourceRef="data_source" responsibilitySetRef="tariffs">
    ...
    result = check_sales_offer_package(None, sales_offer_package)
...
def test_check_dist_assignments(
    type_of_frame_ref_present: bool,
    type_of_frame_ref_correct: bool,
    sales_dist_assignments_present: bool,
    sales_dist_assignment_present: bool,
    sales_dict_assignment_channel_type_present: bool,
    expected: list[str],
):
    sales_offer_packages = """<salesOfferPackages>
      <SalesOfferPackage id="Trip@AdultSingle-SOP@Onboard" version="1.0">
  ...
  <FareFrame version="1.0" id="epd:UK:FSYO:FareFrame_UK_PI_FARE_PRODUCT:Line_9_Outbound:op" dataSourceRef="data_source" responsibilitySetRef="tariffs">
    ...
    result = check_dist_assignments(None, sales_offer_package)
    assert result == expected
...
def test_check_payment_methods(
    type_of_frame_ref_present: bool,
    type_of_frame_ref_correct: bool,
    sales_dist_assignment_payment_method_present: bool,
    expected: list[str],
):
    sales_offer_packages = """<salesOfferPackages>
      <SalesOfferPackage id="Trip@AdultSingle-SOP@Onboard" version="1.0">
  ...
  <FareFrame version="1.0" id="epd:UK:FSYO:FareFrame_UK_PI_FARE_PRODUCT:Line_9_Outbound:op" dataSourceRef="data_source" responsibilitySetRef="tariffs">
    ...
    result = check_payment_methods(None, sales_offer_package)
    assert result == expected
...
def test_check_preassigned_fare_product_ref(
    type_of_frame_ref_present: bool,
    type_of_frame_ref_correct: bool,
    sales_offer_element_preassigned_ref_present: bool,
    expected: list[str],
):
    sales_offer_packages = """<salesOfferPackages>
      <SalesOfferPackage id="Trip@AdultSingle-SOP@Onboard" version="1.0">
  ...
  <FareFrame version="1.0" id="epd:UK:FSYO:FareFrame_UK_PI_FARE_PRODUCT:Line_9_Outbound:op" dataSourceRef="data_source" responsibilitySetRef="tariffs">
    ...
    result = check_fare_product_ref(None, sales_offer_package)
    assert result == expected
...
def test_check_sale_offer_package_elements(
    ...
    sales_offer_packages_present: bool,
    sales_offer_package_present: bool,
    sales_offer_package_elements_present: bool,
    sales_offer_package_element_present: bool,
    sales_offer_type_travel_doc_present: bool,
    expected: list[str],
):
    sales_offer_packages = """<salesOfferPackages>
      <SalesOfferPackage id="Trip@AdultSingle-SOP@Onboard" version="1.0">
  ...
  <FareFrame version="1.0" id="epd:UK:FSYO:FareFrame_UK_PI_FARE_PRODUCT:Line_9_Outbound:op" dataSourceRef="data_source" responsibilitySetRef="tariffs">
    ...
    result = check_sale_offer_package_elements(None, sales_offer_package)
    assert result == expected

...
from fares_etl.validation.app.xml_functions.fare_tables import (
...
def test_is_uk_pi_fare_price_frame_present(
    ...
    fare_tables_present: bool,
    fare_table_present: bool,
    fare_table_prices_for_present: bool,
    expected: list[str],
):
  ...
  {1}
    ...
    result = is_uk_pi_fare_price_frame_present(None, fare_frames)

"""
Unit test for create_sirivm_tfl_zipfile lambda
"""
...
LAMBDA_PATH = "periodic_tasks.create_sirivm_tfl_zip"


class TestLambdaHandler(unittest.TestCase):
    """Unit tests for create_sirivm_tfl_zipfile lambda"""
    ...
    def test_lambda_handler_success(
        ...
        """Testing create_sirivm_tfl_zipfile lambda success path"""
        ...
        self.assertIn("Successfully archived sirivm tfl data", response["body"])
    ...
    def test_lambda_handler_failure(
        ...
        """Testing create_sirivm_tfl_zipfile lambda failure path"""
        mock_environ_get.side_effect = lambda key, default=None: {
            "AWS_SIRIVM_STORAGE_BUCKET_NAME": "test-bucket",
            "AVL_CONSUMER_API_BASE_URL": "http://example.com",
        }.get(key, default)

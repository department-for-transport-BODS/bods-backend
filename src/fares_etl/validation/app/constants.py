...
class ErrorMessages:
    """
    Manage custom error messages from the validator functions
    """
    ...
    MESSAGE_OBSERVATION_TYPE_OF_FRAME_REF_ELEMENT_MISSING = "Mandatory element 'TypeOfFrameRef' is missing from 'FareFrame' - UK_PI_FARE_PRICE"
    MESSAGE_OBSERVATION_TYPE_OF_FARE_FRAME_REF_INCORRECT = "Attribute 'ref' of element 'TypeOfFrameRef' does not include 'UK_PI_FARE_PRICE'"
    ...
    MESSAGE_OBSERVATION_TYPE_OF_FARE_FRAME_REF_FARE_PRODUCT_INCORRECT = "Attribute 'ref' of element 'TypeOfFrameRef' does not include 'UK_PI_FARE_PRODUCT'"
    MESSAGE_OBSERVATION_RESOURCE_FRAME_TYPE_OF_FRAME_REF_ELEMENT_MISSING = "Mandatory element 'TypeOfFrameRef' is missing from 'ResourceFrame' - UK_PI_COMMON"
    ...
    MESSAGE_OBSERVATION_LINE_MISSING = (
        "Mandatory element 'Line' in ServiceFrame is missing"
    )
